...
//Controladores Mundo Animal
use App\Http\Controllers\MaClienteController;
use App\Http\Controllers\CalendarioControlle;
...
Route::resource('macalendario', CalendarioController::class);
Route::get('macalendario.show', [CalendarioController::class, 'show']);
Route::get('calendario/mostrar', [CalendarioController::class, 'show']);
Route::post('calendario/agendar', [CalendarioController::class, 'store']);
Route::post('calendario/editar/{id}', [CalendarioController::class, 'edit']);
Route::post('calendario/actualizar/{evento}', [CalendarioController::class, 'update']);
Route::post('calendario/borrar/{id}', [CalendarioController::class, 'destroy']);
