...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Maestro de Permisos</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/home">Home</a></li>
                        <li class="breadcrumb-item">Personal</li>
                        <li class="breadcrumb-item">Maestro de Permisos</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="crearIngreso" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form name="ingresoLic" action="/maestropermisos" method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="nombreLic">Nombre</label>
                                <input type="text" class="form-control" id="nombreLic" name="nombreLic" placeholder="Ingrese Nombre">
                            </div>
                            <div class="form-group">
                                <label for="abreviaturaLic">Password</label>
                                <input type="text" class="form-control" id="abreviaturaLic" name="abreviaturaLic" placeholder="EX">
                            </div>
