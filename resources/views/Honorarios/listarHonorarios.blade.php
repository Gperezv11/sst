        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="/honorarios">Honorarios</a></li>
                    <li class="breadcrumb-item"><a href="#">Listar Prestadores</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-blue">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <table id="Prestadores_tablas" class="table table-striped table-bordered shadow-lg mt-4" style="width: 100%">
                                <thead>
                                    <tr>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Eliminar Prestador</h5>
                                                        <button type="button" id="modalCLoseX" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <form name="deleteProducto" action="{{route('listarPrestadores.destroy', $ficha->id) }}" method="POST">
                                                        @csrf
                                                        {{ method_field('DELETE') }}
                                    ...
                                    <div class="modal fade" id="editModal{{$ficha->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form id="editPrestador" action ="{{route('listarPrestadores.update', $ficha->id) }}" method="POST">
                                                    @csrf
                                                    {{ method_field('PUT') }}
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="card card-blue">
                                                                <div class="card-header">
                                                                    <h3 class="card-title">Datos del Prestador</h3>
                                                                </div>
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
