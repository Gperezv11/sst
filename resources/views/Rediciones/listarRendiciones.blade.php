...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Listar Rendidores</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/home">Home</a></li>
                    <li class="breadcrumb-item"><a href="/honorarios">Rendiciones</a></li>
                    <li class="breadcrumb-item"><a href="#">Listar Rendidores</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-blue">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <table id="Rendidor_tablas" class="table table-striped table-bordered shadow-lg mt-4" style="width: 100%">
                                <thead>
                                    <tr>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Eliminar Rendidor</h5>
                                                        <button type="button" id="modalCLoseX" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <form name="deleteRendidor" action="{{route('listarRendidores.destroy', $ficha->id) }}" method="POST">
                                                        @csrf
                                                        {{ method_field('DELETE') }}
                                    ...
                                    <div class="modal fade" id="editModal{{$ficha->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form id="editRendidor" action ="{{route('listarRendidores.update', $ficha->id) }}" method="POST">
                                                    @csrf
                                                    {{ method_field('PUT') }}
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="card card-blue">
                                                                <div class="card-header">
                                                                    <h3 class="card-title">Datos del Rendidor</h3>
                                                                </div>
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
...
<script type="text/javascript">
    ...
    $('.toggle-class').on('change',function(){
        ...
        $.ajax({
            type:'GET',
            dataType: 'json',
            url:'{{route("cambiarStatusRendidor")}}',
