        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                $('#butsave').on('click', function() {
                    ...
                    if (rut != "" && nombre_d != "" && pat_d != "" && mat_d != "" && region_d != "" &&
                        comuna_d != "" && dire_d != "" && sector_d != "" && email_d != "" && tele_d != "" &&
                        ref_d != "") {
