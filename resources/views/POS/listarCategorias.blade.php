                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col">
                                                    <div class="input-group">
                                                        <input type="text" name="descuento" class="form-control" style="width: 50%;" onkeypress=" return (event.charCode >= 48 && event.charCode <= 57 || event.charCode == 46)" value="{{$prod->descuento}}" maxlength ="4">
