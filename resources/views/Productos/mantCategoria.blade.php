        ...
        <div class="modal fade" id="crearIngreso" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form name="ingresoLinea" action="/mantCategoria" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            ...
                            <div class="image-contrainer align-content-center" id="nofile">
                                <img id ="blah" src="{{ asset('imagenes/test.jpg') }}" alt="Logo" height="150px" width="150px" class="logo"/>
                                <input accept="image/*" type='file' id="imglogo" name="imglogo" class="file" required/>
                            </div>
                ...
                <div class="modal fade" id="editModal{{$tipo->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form name="upCategoria" action="{{route('mantCategoria.update', $tipo->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PUT') }}
                            <div class="modal-body">
                                <div class="form-group">
                                ...
                                <div class="image-contrainer align-content-center" id="nofile">
                                    <img id ="blah" src="{{ asset('imagenes/' . $tipo->imagen) }}" alt="Logo" height="150px" width="150px" class="logo"/>
                ...
                <div class="modal fade" id="eliminarModal{{$tipo->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form name="deleteNegocio" action="{{route('mantCategoria.destroy', $tipo->id) }}" method="POST">
                                @csrf
                                {{ method_field('DELETE') }}
                                <div class="modal-body">
                                    <div class="form-group">
...
@section('scripts')
    <script>
        $(document).ready( function () {
            ...
            //eliminar registro
            $('#eli.btn-danger').on('click',function(){
                var ficha_id=$(this).data('id');
                //alert("funcion eliminar : " + ficha_id);
                
                $.ajax({                    
                    type:'GET',
                    url:"{{ route('eliminarCategoria' ,$tipo->id) }}",
                    data:{'id':ficha_id},
