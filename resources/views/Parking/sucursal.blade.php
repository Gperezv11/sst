        ...
        <div class="modal fade" id="crearIngreso" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form name="ingresoTipo" action="/sucursal" method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="nombreLic">Sucursal</label>
                                <input type="text" class="form-control" id="nombreTipo" name="nombreTipo" placeholder="Ingrese Nombre">
                            </div>
                            <div class="form-group">
                                <label for="abreviaturaTipo">Direccion</label>
                ...
                <div class="modal fade" id="editModal{{$tipo->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form name="upLineaNegocio" action="{{route('sucursal.update', $tipo->id) }}" method="POST">
                                @csrf
                                {{ method_field('PUT') }}
                                <div class="modal-body">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="abreviaturaTipo">Direccion</label>
                                        <input type="text" class="form-control" id="abreviaturaTipo_edit" name="abreviaturaTipo_edit" placeholder="" value="{{$tipo->abreviatura}}">
                                    </div>
                ...
                <div class="modal fade" id="eliminarModal{{$tipo->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form name="deleteNegocio" action="{{route('sucursal.destroy', $tipo->id) }}" method="POST">
                                @csrf
                                {{ method_field('DELETE') }}
                                <div class="modal-body">
                                    <div class="form-group">
