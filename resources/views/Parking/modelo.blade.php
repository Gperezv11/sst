        ...
        <div class="modal fade" id="crearIngreso" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form name="ingresoLinea" action="/modelo" method="POST">
                        @csrf
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="nombreLic">Modelo</label>
                                <input type="text" class="form-control" id="nombreTipo" name="nombreTipo" placeholder="Ingrese Modelo" required>
                            </div>
                            <div class="form-group">
            ...
            @foreach($tipos as $tipo)
                ...
                <div class="modal fade" id="editModal{{$tipo->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form name="upSubmarca" action="{{route('modelo.update', $tipo->id) }}" method="POST">
                                @csrf
                                {{ method_field('PUT') }}
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <select id="id_marca" name="id_marca" class="form-control" >
                                            ...
                                            @foreach($vehiculos as $vehiculo)
                                                <option value="{{$vehiculo->id}}"{{$vehiculo->id == $tipo->id_marca ? 'selected' : ''}}>{{$vehiculo->nombre}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                ...
                <div class="modal fade" id="eliminarModal{{$tipo->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Eliminar Modelos</h5>
                                <button type="button" id="modalCLoseX" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form name="deleteSubmarca" action="{{route('modelo.destroy', $tipo->id) }}" method="POST">
                                @csrf
                                {{ method_field('DELETE') }}
                                <div class="modal-body">
                                    <div class="form-group">
