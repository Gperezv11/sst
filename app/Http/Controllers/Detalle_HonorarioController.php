...
class Detalle_HonorarioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $bruto2 = $request->bruto2;
        $bruto3 = $request->bruto3;
        $bruto4 = $request->bruto4;
        $bruto5 = $request->bruto5;
        $id = DB::table('honorarios')->select('id')->where('n_documento_honorario', '=',$nhonorario)->first();
        DB::table('detalle_honorarios')->insert([
            'tipo_servicio_id' => $request->servicio,
           ...
           if($bruto2 != ""){
            DB::table('detalle_honorarios')->insert([
            'tipo_servicio_id' => $request->servicio2,
           ...
           if($bruto3 != ""){
             DB::table('detalle_honorarios')->insert([
            'tipo_servicio_id' => $request->servicio3,
           ...
           if($bruto4 != ""){
            DB::table('detalle_honorarios')->insert([
            'tipo_servicio_id' => $request->servicio4,
           ...
           if($bruto5 != ""){
            DB::table('detalle_honorarios')->insert([
            'tipo_servicio_id' => $request->servicio5,
